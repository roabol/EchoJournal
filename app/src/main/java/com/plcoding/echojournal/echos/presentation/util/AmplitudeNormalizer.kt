...
object AmplitudeNormalizer {
    ...
    // Example of result in case targetSize = 3
    ...
    // Example of result in case targetSize = 5
    // [0, 0.2, 0.3] -> [0, 0.1, 0.2, 0.25, 0.3]

    // Example of result in case targetSize = 9
    // [0, 0.1, 0] -> [0, x, x, x, 0.1, x, x, x, 0]
    //                [0, 0.025, 0.05, 0.075, 0.1, 0.075, 0.05, 0.025, 0]
